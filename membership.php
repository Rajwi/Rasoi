...
<div class="topnav" id="myTopnav">
  ...
  <a href="menu.php">Meal Plans</a>
       <a  href="contact_us.php">Contact Us</a>
             <a class="active" href="membership.php">Join Us</a>
 ...
 <?php  include_once("order.php");
    ...
    <div id="content-wrap" style="height:440px !important;">
        <div class="row">
           ...
           <div class="col-md-6" >
               <img src="images/m1.jpg" style="height:160px">
               <H3>Want To JOIN US  ?</H2>
                  <p>JUST FOLLOW SOME SIMPLE STEPS THAT MENTION BELOW</P>
               <li>Just click on the link given below
               </li>
           <li> 
               <a href="images/meber_form.pages" download><i class="fa fa-download"></i>membership form
  
</a></li>

               <li>Download the form.</li>
               <li>Fill up all the details that required to become a member of our business.</li>
               <li>Send the form to our EMAIL address.</li>
               <li>EMAIL:-  info@rasoi.com</li>
